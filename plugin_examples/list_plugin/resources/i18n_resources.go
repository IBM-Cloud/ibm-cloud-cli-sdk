...
func i18nResourcesAllEn_usJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "i18n/resources/all.en_US.json", size: 2338, mode: os.FileMode(436), modTime: time.Unix(1655241492, 0)}
...
func i18nResourcesAllZh_hansJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "i18n/resources/all.zh_Hans.json", size: 2251, mode: os.FileMode(436), modTime: time.Unix(1654899409, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
